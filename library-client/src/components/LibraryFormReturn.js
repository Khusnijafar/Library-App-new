                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div className="form-inline"> 
                                ...
                                <div className="form-group">
                                    <label className="col-sm-2 col-form-label">Forfeitr</label>
                                    <div className="col-sm-3">
                                        <input type="text" className="form-control" placeholder="Rp.0" name='forfeit' value={this.state.forfeit} onChange={this.handleLoanBookChange}
                                         required />
                                    </div>
                                </div>
                               <div>
                                   
                                <button type="submit" className="ui inverted segment green button" onClick={this.handleReturnBook}>
